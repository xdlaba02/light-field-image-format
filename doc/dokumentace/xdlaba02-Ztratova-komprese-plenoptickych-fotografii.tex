...
\projectinfo{
  ...
  title.en={Lossy compression of light field photography}, % název práce v angličtině / thesis title in english
  ...
  % Abstrakt / Abstract
  abstract.cs={
    Cílem této práce je vhodně navrhnout a implementovat ztrátový kodek pro plenoptické fotografie.
    ...
    Zrcadlením metody JPEG do čtyř rozměrů se povedlo při stejném PSNR dosáhnout kompresního poměru X:Y, což je oproti referenčnímu 2D JPEG kodeku zlepšení o ZZ\%.
...
\begin{document}
  ...
  % ----------------------------------------------
  \input{xdlaba02-Ztratova-komprese-plenoptickych-fotografii-01-kapitoly-chapters}
...
\fi
  ...
  % Přílohy / Appendices
  %\input{xdlaba02-Ztratova-komprese-plenoptickych-fotografii-30-prilohy-appendices}
