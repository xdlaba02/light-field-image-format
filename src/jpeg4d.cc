      ...
      for (uint64_t block_y = 0; block_y < blocks_height; block_y++) {
        ...
        for (uint64_t block_x = 0; block_x < blocks_width; block_x++) {
          ...
          * Konvertuje RGB na YCbCr
          ...
          Block<double, 4> block_Y_transformed  {};
          Block<double, 4> block_Cb_transformed {};
          Block<double, 4> block_Cr_transformed {};

          auto fdct = [](Block<int8_t, 4> &block_shifted, Block<double, 4> &block_transformed) {
            fdct4([&](uint8_t x, uint8_t y, uint8_t ix, uint8_t iy){ return block_shifted[iy*8*8*8 + ix*8*8 + y*8 + x]; }, [&](uint8_t x, uint8_t y, uint8_t ix, uint8_t iy) -> double & { return block_transformed[iy*8*8*8 + ix*8*8 + y*8 + x]; });
          };
    ...
    for (uint64_t block_ix = 0; block_ix < blocks_images_x; block_ix++) {
      for (uint64_t block_y = 0; block_y < blocks_height; block_y++) {
        ...
        for (uint64_t block_x = 0; block_x < blocks_width; block_x++) {
          ...
          Block<double, 4> block_Y_dequantized  {};
          Block<double, 4> block_Cb_dequantized {};
          Block<double, 4> block_Cr_dequantized {};
          ...
          Block<double, 4> block_Y_detransformed  {};
          Block<double, 4> block_Cb_detransformed {};
          Block<double, 4> block_Cr_detransformed {};

          auto idct = [](Block<double, 4> &block_dequantized, Block<double, 4> &block_detransformed) {
            idct4([&](uint8_t x, uint8_t y, uint8_t ix, uint8_t iy){ return block_dequantized[iy*8*8*8 + ix*8*8 + y*8 + x]; }, [&](uint8_t x, uint8_t y, uint8_t ix, uint8_t iy) -> double & { return block_detransformed[iy*8*8*8 + ix*8*8 + y*8 + x]; });
          };
          ...
          Block<double, 4> block_Y_deshifted  {};
          Block<double, 4> block_Cb_deshifted {};
          Block<double, 4> block_Cr_deshifted {};
