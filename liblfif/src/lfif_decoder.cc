...
template int LFIFDecompress<2, uint8_t>(ifstream &, const uint64_t *, uint8_t, uint8_t *);
template int LFIFDecompress<3, uint8_t>(ifstream &, const uint64_t *, uint8_t, uint8_t *);
template int LFIFDecompress<4, uint8_t>(ifstream &, const uint64_t *, uint8_t, uint8_t *);

template int LFIFDecompress<2, uint16_t>(ifstream &, const uint64_t *, uint16_t, uint16_t *);
template int LFIFDecompress<3, uint16_t>(ifstream &, const uint64_t *, uint16_t, uint16_t *);
template int LFIFDecompress<4, uint16_t>(ifstream &, const uint64_t *, uint16_t, uint16_t *);

template<size_t D, typename T>
int LFIFDecompress(ifstream &input, const uint64_t img_dims[D+1], T max_rgb_value, T *rgb_data) {
